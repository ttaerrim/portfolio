export default function IntroduceBox() {
  return (
    <div className='flex flex-col py-7 px-5 gap-4 w-full'>
      <h1 className='text-main-blue text-[5rem] font-bold whitespace-break-spaces leading-normal'>{`안녕하세요\n저는 ______________한\n프론트엔드 개발자 이태림입니다`}</h1>
      <ol className='whitespace-break-spaces list-decimal pl-8 text-[1.7rem]'>
